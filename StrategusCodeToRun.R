...
# visualize the results generated by Strategus - pop up a shiny app for Sunburst
library(TreatmentPatterns)
TreatmentPatterns::launchResultsExplorer("results/Eunomia/strategusOutput/TreatmentPatternsModule")
